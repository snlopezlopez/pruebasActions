context("Gastos en Cesta Solo Fibra", () => {
  beforeEach(() => {
    cy.visitSimyo();
    cy.wait(1000);
  });
  ...
  it("Comprobar gastos desde 2 a 3 Fibras", () => {
    cy.get("a#buttonFibra").click();
    cy.get("a.grayButton.btn.addCart").eq(0).click();
    cy.wait(1000);
    cy.get("a.cart:first").click();
    ...
    cy.get("div.summary.purchase")
      ...
      .children("#gastosEnvio.precio")
      .eq(1)
      .should("have.text", "19,98€");
    cy.get("p#totalCompra.precio.orange").should("have.text", "19,98€");
    //cy.get('a.close-items-20').click()

    cy.wait(1000);
    cy.get(".select").click();
    cy.get("#dropdown2_10").click();
    //cy.get('input.a-input-text.a-width-small.sc-quantity-textfield.sc-hidden').type("3").clear()
    cy.get(
      "input.a-input-text.a-width-small.sc-quantity-textfield.sc-hidden"
    ).type("3");
    cy.get("#a-autoid-1-announce").click();
    ...
    cy.get("div.summary.purchase")
      ...
      .children("#gastosEnvio.precio")
      .eq(1)
      .should("have.text", "29,97€");
    cy.get("p#totalCompra.precio.orange").should("have.text", "29,97€");
    //cy.get('a.close-items-20').click()
  });
