context("Proceso compra tarifa y fibra", () => {
  beforeEach(() => {
    ...
    //cy.get('a.arrowed:first').click() No funciona el HEADER
    //cy.visit('https://pre2-www.simyo.es/simyo/telefonia-movil/telefonos-libres.htm')
    //cy.wait(1000)
    //cy.get('.content-shop').get('#item_phone_content_4028f39565ada1990165b2ecad9f7568').contains("AÑADIR A LA CESTA").click()
