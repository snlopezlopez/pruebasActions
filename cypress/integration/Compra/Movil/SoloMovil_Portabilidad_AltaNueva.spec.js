context("Proceso compra tarifa móvil", () => {
  ...
  it("Comprar 1 linea Usuario nuevo ", () => {
    ...
    cy.generateDni().then((result) => {
      cy.get("input#document_number_different_holder-654111444").type(result);
    });

    cy.get("select#nationality_select_different_holder-654111444")
      .select("1724")
      .should("contain", "España");
    cy.get("input#firstname_different_holder-654111444").type("Alfredo");
    cy.get("input#lastname1_different_holder-654111444").type("González");
