...
describe(
  "Contratacion de fibra y línea móvil con resolucion de pantalla movil",
  ...
  () => {
    ...
    it("Responsive - Compra Fibra y Móvil - Usuario Prelogado", () => {
      ...
      cy.get(".nuevo_numero_radio_row").children().eq(0).click();
